...
--       Or automatically check if TriangleFill(mesh) was successful, if not
--       we fall back to the SeparateFacesBySelectedEdges strategy
--       IMPORTANT NOTE: Previous alternative does not work in ProMesh directly
--       In fact: Triangulate first with low degree angle e.g. 5 then
--       retriangulate subsset wise with a high angle e.g. 20 will reemedy this
ClearSelection(mesh)
